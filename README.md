...
* [Side projects](https://github.com/apache/incubator-dubbo)
    ...
    * [Dubbo rpc-jsonrpc](https://github.com/apache/incubator-dubbo-rpc-jsonrpc) - The Json rpc module of Apache Dubbo projecthttp://dubbo.apache.org/books/dubbo-admin-book/
...
* [Dubbo admin manual(English)](http://dubbo.apache.org/books/dubbo-admin-book-en/) or [Dubbo管理手册(中文)]() - Describe how to use Dubbo registry and admin-console.
